...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-full p-1.5 opacity-70 transition-opacity hover:bg-secondary hover:opacity-100 focus:outline-none">
